...
user_me_route = APIRouter()


@user_me_route.get(route_paths.ROUTE_USER_ME, response_model=UserReadSchema)
...
@user_me_route.put(route_paths.ROUTE_USER_ME, response_model=UserReadSchema)
